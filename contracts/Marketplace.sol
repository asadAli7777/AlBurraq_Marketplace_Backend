...
contract Marketplace is ERC1155Holder, ReentrancyGuard {
    ...
    uint256 public minBidIncrement = 1000000000000000; // 0.01 Eth
    uint256 public registrationFee = 1000000000000000; // 0.01 Eth
    ...
    function register() public payable onlyUnBLocked {
        ...
        (bool sentToSeller, ) = owner.call{value: msg.value}("");
    ...
    function purchaseItem(
        ...
        /// payment sepraion
        uint256 marketplacePayment = getMArketPlaceFee(_totalPrice);
        ...
        onlyUnBLocked
    {
        ...
        require(msg.value >= auctions[_auctionCount].pricePlusFee + minBidIncrement,"Trying to send less Amount");
